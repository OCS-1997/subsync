...
export const THEMES = [
  ...
  },
  {
    ...
    tokens: {
      ...
      "--input": "45 20% 25%",
      "--ring": "45 60% 50%",
      "--sidebar-background": "45 20% 8%",
      "--sidebar-foreground": "45 20% 90%",
      "--sidebar-primary": "45 60% 50%",
  ...
  },
  {
    ...
    tokens: {
      ...
      "--destructive": "0 60% 50%",
      "--destructive-foreground": "140 20% 90%",
      "--border": "140 30% 25%",
      "--input": "140 30% 25%",
      "--ring": "140 50% 50%",
      "--sidebar-background": "140 30% 8%",
      "--sidebar-foreground": "140 20% 90%",
      "--sidebar-primary": "140 50% 50%",
  ...
  },
  {
    ...
    tokens: {
      ...
      "--card": "280 60% 10%",
      "--card-foreground": "60 100% 70%",
      "--popover": "280 60% 10%",
      "--popover-foreground": "60 100% 70%",
      "--primary": "320 100% 60%",
      "--primary-foreground": "0 0% 100%",
      ...
      "--accent": "280 40% 25%",
      "--accent-foreground": "60 100% 70%",
      "--destructive": "0 100% 50%",
      "--destructive-foreground": "0 0% 100%",
      "--border": "320 100% 30%",
      "--input": "320 100% 30%",
      "--ring": "320 100% 60%",
      "--sidebar-background": "280 60% 5%",
      "--sidebar-foreground": "60 100% 70%",
      "--sidebar-primary": "320 100% 60%",
      "--sidebar-border": "320 100% 20%",
    },
  },
  {
    id: "retrowave",
  ...
  },
  {
    ...
    tokens: {
      ...
      "--foreground": "260 40% 20%",
      "--card": "260 50% 99%",
      "--card-foreground": "260 40% 20%",
      "--popover": "260 50% 99%",
      "--popover-foreground": "260 40% 20%",
      "--primary": "260 60% 60%",
      "--primary-foreground": "0 0% 100%",
      "--secondary": "260 30% 90%",
      ...
      "--input": "260 30% 85%",
      "--ring": "260 60% 60%",
      "--sidebar-background": "260 40% 95%",
      "--sidebar-foreground": "260 40% 20%",
      "--sidebar-primary": "260 60% 60%",
      "--sidebar-border": "260 30% 88%",
    },
  },
  {
    id: "rose-quartz",
    ...
    tokens: {
      ...
      "--input": "340 30% 85%",
      "--ring": "340 60% 60%",
      "--sidebar-background": "340 40% 95%",
      "--sidebar-foreground": "340 40% 20%",
  ...
  
  {
    ...
    tokens: {
      ...
      "--foreground": "10 40% 20%",
      "--card": "10 80% 96%",
      "--card-foreground": "10 40% 20%",
      "--popover": "10 80% 96%",
      "--popover-foreground": "10 40% 20%",
      "--primary": "15 90% 65%",
      "--primary-foreground": "0 0% 100%",
      "--secondary": "10 60% 90%",
      "--secondary-foreground": "10 40% 20%",
      "--muted": "10 40% 90%",
      "--muted-foreground": "10 30% 60%",
      "--accent": "10 50% 85%",
      "--accent-foreground": "10 40% 20%",
      "--destructive": "0 70% 60%",
      "--destructive-foreground": "0 0% 100%",
      "--border": "10 40% 85%",
      "--input": "10 40% 85%",
      "--ring": "15 90% 65%",
      "--sidebar-background": "10 70% 95%",
      "--sidebar-foreground": "10 40% 20%",
      "--sidebar-primary": "15 90% 65%",
      "--sidebar-border": "10 40% 88%",
    },
  },
];
