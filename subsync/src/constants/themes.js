export const FONT_PRESETS = {
  ...
  monospace: [
    ...
    { id: "system-mono", name: "System Mono", value: "ui-monospace, SFMono-Regular, monospace" },
  ],
};
...
export const THEMES = [
  ...
  },
  {
    id: "custom",
    name: "Custom Theme",
    type: "light", // Default to light, but will be overridden by custom tokens
    tokens: {
      "--background": "0 0% 100%",
      "--foreground": "240 10% 3.9%",
      "--card": "0 0% 100%",
