    ...
    return (
        <div className="min-h-screen bg-slate-50/30 dark:bg-transparent px-8 py-8">
            <div className="max-w-[1600px] mx-auto space-y-8">
                ...
                <div className="flex items-center justify-between p-1 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-[1.5rem] w-fit shadow-sm">
                    <button
